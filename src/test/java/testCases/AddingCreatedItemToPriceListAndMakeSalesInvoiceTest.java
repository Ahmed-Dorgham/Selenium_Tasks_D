...
public class AddingCreatedItemToPriceListAndMakeSalesInvoiceTest extends TestBase {
  ...
  //  private final String password = "A@d3y2M6u6Nk";
    ...
    String priceListfilePath = System.getProperty("user.dir") + "\\ExcelSheets\\pricelist.xlsx";
  ...
  public Object[][] readingData () throws IOException {
    ...
    public void addCreatedItemToPriceListAndMakeSalesInvoice(String emailId, String password, String itemName) throws InterruptedException, AWTException {
